  ...
  return (
    <>
      <main className='min-w-full w-full h-full h-vh mx-auto'>
        <nav className='sticky top-0 z-50 bg-white/80 backdrop-blur-xl w-full border-b border-gray-300 px-6 py-4'>
        ...
        <section className='w-full'>
          <div className='max-w-screen-2xl w-full flex flex-col mx-auto py-5s'>
            <div className="relative w-full overflow-hidden max-h-[500px]">
              <div className="absolute flex inset-0 bg-gradient-to-r from-white via-transparent to-white">
              </div>
        ...
        <section className='w-full z-10 border-b grid mb-[2000px] grid-cols-[repeat(auto-fit,minmax(200px,1fr))] bg-white'>
          <div className='flex items-center max-w-screen-2xl w-full mx-auto'>
